defmodule ExSwagger.Schema.Swagger20 do
  @schema %{"$schema" => "http://json-schema.org/draft-04/schema#",
  "additionalProperties" => false,
  "definitions" => %{"responseDefinitions" => %{"additionalProperties" => %{"$ref" => "#/definitions/response"},
      "description" => "One or more JSON representations for parameters",
      "type" => "object"},
    "securityRequirement" => %{"additionalProperties" => %{"items" => %{"type" => "string"},
        "type" => "array", "uniqueItems" => true}, "type" => "object"},
    ...
    "schema" => %{"additionalProperties" => false,
      ...
      "properties" => %{"$ref" => %{"type" => "string"},
        ...
        "items" => %{"anyOf" => [%{"$ref" => "#/definitions/schema"},
           %{"items" => %{"$ref" => "#/definitions/schema"}, "minItems" => 1,
             "type" => "array"}], "default" => %{}},
        ...
        "uniqueItems" => %{"$ref" => "http://json-schema.org/draft-04/schema#/properties/uniqueItems"},
        "xml" => %{"$ref" => "#/definitions/xml"}}, "type" => "object"},
    "paths" => %{"additionalProperties" => false,
      ...
      "type" => "object"},
    "mimeType" => %{"description" => "The MIME type of the HTTP message.",
      "type" => "string"},
    "license" => %{"additionalProperties" => false,
      ...
      "properties" => %{"name" => %{"description" => "The name of the license type. It's encouraged to use an OSI compatible license.",
          "type" => "string"},
        "url" => %{"description" => "The URL pointing to the license.",
          "format" => "uri", "type" => "string"}}, "required" => ["name"],
      "type" => "object"},
    ...
    "queryParameterSubSchema" => %{"additionalProperties" => false,
      ...
      "properties" => %{"allowEmptyValue" => %{"default" => false,
        ...
        "default" => %{"$ref" => "#/definitions/default"},
        "description" => %{"description" => "A brief description of the parameter. This could contain examples of use.  GitHub Flavored Markdown is allowed.",
          "type" => "string"}, "enum" => %{"$ref" => "#/definitions/enum"},
        "exclusiveMaximum" => %{"$ref" => "#/definitions/exclusiveMaximum"},
        "exclusiveMinimum" => %{"$ref" => "#/definitions/exclusiveMinimum"},
        "format" => %{"type" => "string"},
        "in" => %{"description" => "Determines the location of the parameter.",
          "enum" => ["query"], "type" => "string"},
        "items" => %{"$ref" => "#/definitions/primitivesItems"},
        "maxItems" => %{"$ref" => "#/definitions/maxItems"},
        "maxLength" => %{"$ref" => "#/definitions/maxLength"},
        "maximum" => %{"$ref" => "#/definitions/maximum"},
    ...
    "basicAuthenticationSecurity" => %{"additionalProperties" => false,
      "patternProperties" => %{"^x-" => %{"$ref" => "#/definitions/vendorExtension"}},
      "properties" => %{"description" => %{"type" => "string"},
        "type" => %{"enum" => ["basic"], "type" => "string"}},
      "required" => ["type"], "type" => "object"},
    "schemesList" => %{"description" => "The transfer protocol of the API.",
      "items" => %{"enum" => ["http", "https", "ws", "wss"],
    ...
    "oauth2ImplicitSecurity" => %{"additionalProperties" => false,
      ...
      "properties" => %{"authorizationUrl" => %{"format" => "uri",
        ...
        "flow" => %{"enum" => ["implicit"], "type" => "string"},
        "scopes" => %{"$ref" => "#/definitions/oauth2Scopes"},
        "type" => %{"enum" => ["oauth2"], "type" => "string"}},
      "required" => ["type", "flow", "authorizationUrl"], "type" => "object"},
    "minItems" => %{"$ref" => "http://json-schema.org/draft-04/schema#/definitions/positiveIntegerDefault0"},
    "bodyParameter" => %{"additionalProperties" => false,
      ...
      "required" => ["name", "in", "schema"], "type" => "object"},
    "maxItems" => %{"$ref" => "http://json-schema.org/draft-04/schema#/definitions/positiveInteger"},
    "primitivesItems" => %{"additionalProperties" => false,
      ...
      "properties" => %{"collectionFormat" => %{"$ref" => "#/definitions/collectionFormat"},
        ...
        "uniqueItems" => %{"$ref" => "#/definitions/uniqueItems"}},
      "type" => "object"},
    "apiKeySecurity" => %{"additionalProperties" => false,
      "patternProperties" => %{"^x-" => %{"$ref" => "#/definitions/vendorExtension"}},
      "properties" => %{"description" => %{"type" => "string"},
        "in" => %{"enum" => ["header", "query"], "type" => "string"},
        "name" => %{"type" => "string"},
        "type" => %{"enum" => ["apiKey"], "type" => "string"}},
      "required" => ["type", "name", "in"], "type" => "object"},
    ...
    "parametersList" => %{"additionalItems" => false,
      ...
      "items" => %{"oneOf" => [%{"$ref" => "#/definitions/parameter"},
         %{"$ref" => "#/definitions/jsonReference"}]}, "type" => "array",
      "uniqueItems" => true},
    ...
    "oauth2ApplicationSecurity" => %{"additionalProperties" => false,
      "patternProperties" => %{"^x-" => %{"$ref" => "#/definitions/vendorExtension"}},
      "properties" => %{"description" => %{"type" => "string"},
        "flow" => %{"enum" => ["application"], "type" => "string"},
        "scopes" => %{"$ref" => "#/definitions/oauth2Scopes"},
        "tokenUrl" => %{"format" => "uri", "type" => "string"},
        "type" => %{"enum" => ["oauth2"], "type" => "string"}},
      "required" => ["type", "flow", "tokenUrl"], "type" => "object"},
    ...
    "nonBodyParameter" => %{"oneOf" => [%{"$ref" => "#/definitions/headerParameterSubSchema"},
      ...
      "required" => ["name", "in", "type"], "type" => "object"},
    "contact" => %{"additionalProperties" => false,
      ...
      "properties" => %{"email" => %{"description" => "The email address of the contact person/organization.",
        ...
        "name" => %{"description" => "The identifying name of the contact person/organization.",
          "type" => "string"},
        "url" => %{"description" => "The URL pointing to the contact information.",
          "format" => "uri", "type" => "string"}}, "type" => "object"},
    "parameterDefinitions" => %{"additionalProperties" => %{"$ref" => "#/definitions/parameter"},
      "description" => "One or more JSON representations for parameters",
      "type" => "object"},
    "default" => %{"$ref" => "http://json-schema.org/draft-04/schema#/properties/default"},
    "collectionFormat" => %{"default" => "csv",
      "enum" => ["csv", "ssv", "tsv", "pipes"], "type" => "string"},
    "description" => %{"$ref" => "http://json-schema.org/draft-04/schema#/properties/description"},
    ...
    "oauth2AccessCodeSecurity" => %{"additionalProperties" => false,
      ...
      "properties" => %{"authorizationUrl" => %{"format" => "uri",
          "type" => "string"}, "description" => %{"type" => "string"},
        "flow" => %{"enum" => ["accessCode"], "type" => "string"},
        "scopes" => %{"$ref" => "#/definitions/oauth2Scopes"},
        "tokenUrl" => %{"format" => "uri", "type" => "string"},
        "type" => %{"enum" => ["oauth2"], "type" => "string"}},
    ...
    "xml" => %{"additionalProperties" => false,
      ...
      "properties" => %{"attribute" => %{"default" => false,
        ...
        "namespace" => %{"type" => "string"}, "prefix" => %{"type" => "string"},
    ...
    "pathParameterSubSchema" => %{"additionalProperties" => false,
      ...
      "properties" => %{"collectionFormat" => %{"$ref" => "#/definitions/collectionFormat"},
        ...
        "name" => %{"description" => "The name of the parameter.",
          "type" => "string"},
        "pattern" => %{"$ref" => "#/definitions/pattern"},
        "required" => %{"description" => "Determines whether or not this parameter is required or optional.",
    ...
    "info" => %{"additionalProperties" => false,
      ...
      "properties" => %{"contact" => %{"$ref" => "#/definitions/contact"},
        "description" => %{"description" => "A longer description of the API. Should be different from the title.  GitHub Flavored Markdown is allowed.",
          "type" => "string"},
        "license" => %{"$ref" => "#/definitions/license"},
        "termsOfService" => %{"description" => "The terms of service for the API.",
          "type" => "string"},
        "title" => %{"description" => "A unique and precise title of the API.",
          "type" => "string"},
        "version" => %{"description" => "A semantic version number of the API.",
          "type" => "string"}}, "required" => ["version", "title"],
      "type" => "object"},
    "enum" => %{"$ref" => "http://json-schema.org/draft-04/schema#/properties/enum"},
    "pathItem" => %{"additionalProperties" => false,
      ...
      "properties" => %{"$ref" => %{"type" => "string"},
        ...
        "put" => %{"$ref" => "#/definitions/operation"}}, "type" => "object"},
    "operation" => %{"additionalProperties" => false,
      ...
      "properties" => %{"consumes" => %{"allOf" => [%{"$ref" => "#/definitions/mediaTypeList"}],
        ...
        "description" => %{"description" => "A longer description of the operation, GitHub Flavored Markdown is allowed.",
          "type" => "string"},
        "externalDocs" => %{"$ref" => "#/definitions/externalDocs"},
        "operationId" => %{"description" => "A unique identifier of the operation.",
          "type" => "string"},
        "parameters" => %{"$ref" => "#/definitions/parametersList"},
        ...
        "summary" => %{"description" => "A brief summary of the operation.",
          "type" => "string"},
        "tags" => %{"items" => %{"type" => "string"}, "type" => "array",
          "uniqueItems" => true}}, "required" => ["responses"],
      "type" => "object"},
    "exclusiveMaximum" => %{"$ref" => "http://json-schema.org/draft-04/schema#/properties/exclusiveMaximum"},
    "maxLength" => %{"$ref" => "http://json-schema.org/draft-04/schema#/definitions/positiveInteger"},
    "oauth2PasswordSecurity" => %{"additionalProperties" => false,
      "patternProperties" => %{"^x-" => %{"$ref" => "#/definitions/vendorExtension"}},
      "properties" => %{"description" => %{"type" => "string"},
        "flow" => %{"enum" => ["password"], "type" => "string"},
        "scopes" => %{"$ref" => "#/definitions/oauth2Scopes"},
        "tokenUrl" => %{"format" => "uri", "type" => "string"},
        "type" => %{"enum" => ["oauth2"], "type" => "string"}},
      "required" => ["type", "flow", "tokenUrl"], "type" => "object"}},
  ...
  "properties" => %{"basePath" => %{"description" => "The base path to the API. Example: '/api'.",
    ...
    "externalDocs" => %{"$ref" => "#/definitions/externalDocs"},
    "host" => %{"description" => "The host (name or ip) of the API. Example: 'swagger.io'",
    ...
    "swagger" => %{"description" => "The Swagger version of this document.",
      "enum" => ["2.0"], "type" => "string"},
    "tags" => %{"items" => %{"$ref" => "#/definitions/tag"}, "type" => "array",
      "uniqueItems" => true}}, "required" => ["swagger", "info", "paths"],
  "title" => "A JSON Schema for Swagger 2.0 API.", "type" => "object"}
